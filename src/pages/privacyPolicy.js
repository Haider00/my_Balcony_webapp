      ...
      >
        <CardContent>
          ...
          <Typography variant="subtitle1">
            Your privacy is important to us. It is Balcony's policy to respect
            your privacy and comply with any applicable requirements regarding
          ...
          <br />
          <Typography variant="subtitle1">
            This policy is effective as of 21 February 2021 and was last updated
            on 21 February 2021.
          </Typography>
          <br />
          <Typography sx={{ fontWeight: "bold", mb: 2 }} variant="h3">
          ...
          <Typography variant="subtitle1">
            ...
            security. We will work with the situations that are applicable to us
          ...
          <ul style={{ listStyleType: "square" }}>
            ...
            <li>
              In order to establish trust, we work towards working with our
              users and cleaners that we would do the best we can in handling
              almost any situation that comes our way.
            </li>
            <li>
          ...
          <Typography variant="subtitle1">
            ...
            data protection as the country in which you initially provided the
            ...
            accordance with the requirements of applicable situations; and (ii)
            we will protect the transferred personal information in accordance
          ...
          <br />
          <Typography variant="subtitle1">
            If you believe that we have breached a relevant data protection and
            would like to make a complaint, please contact us using the details
            ...
            contact a third-party body or data protection authority in relation
            to your complaint.
          </Typography>
          <br />
          <Typography sx={{ fontWeight: "bold", mb: 2 }} variant="h3">
          ...
          <Typography variant="subtitle1">
            ...
            updates to our business processes, current acceptable busienss
            changes or third-party changes. If we decide to change this privacy
            policy, we will post the changes here at the same link by which you
            are accessing this privacy policy.
          </Typography>
          <br />
          <Typography variant="subtitle1">
            If required, we will get your permission or give you the opportunity
