      ...
      >
        <CardContent>
          ...
          <Typography variant="subtitle1">
            ...
            <Link href="https://www.balcony.ws/">https://www.balcony.ws/</Link>{" "}
          ...
          <Typography variant="subtitle1">
            ...
            applicable business service agreements. If you do not agree with
            these Terms of Service, you are not allowed from using or accessing
            this website or using any other services provided by Balcony.
          </Typography>
          <br />
          <br />
          <br />
          <Typography variant="subtitle1">
            We, Balcony, reserve the right to review and amend any of these
          ...
          <ol>
            ...
            <li>
              ...
              break the User Agreement of privacy or other rights of third
              parties.
            </li>
          </ol>
          <br />
          ...
          <br />
          <Typography variant="subtitle1">
            The Business Structure in the materials contained in this website
            are owned by or licensed to Balcony which makes our brand
            distinctive from other businesses. We grant our users permission to
          ...
          <br />
          <Typography variant="subtitle1">
            We are able to acquire a license, not a transfer of title. This
          ...
          <Typography variant="subtitle1">
            ...
            is' basis. To the extent permitted by business service agreements,
            Balcony makes no warranties, expressed or implied, and hereby
            disclaims and negates all other warranties including, without
            limitation, implied warranties or conditions of merchantability,
            fitness for a particular purpose, or non-infringement of Business
            Structure, or other violation of rights.
          </Typography>
          <br />
          <br />
          <br />
          <Typography variant="subtitle1">
            In no event shall Balcony or its suppliers be liable for any
            ...
            materials on this website, even if Balcony or an authorized
          ...
          <Typography variant="subtitle1">
            ...
            for general information purposes only. Balcony does not warrant or
          ...
          <br />
          <Typography variant="subtitle1">
            Balcony has not reviewed all of the sites linked to its website and
            is not responsible for the contents of any such linked site. The
            inclusion of any link does not imply endorsement, approval, or
            control by Balcony of the site. Use of any such linked site is at
          ...
          <br />
          <Typography variant="subtitle1">
            These Terms of Service are to be implemented during business
            operations, and at the time of our vendors/clients offering the
            service.
          </Typography>
        </CardContent>
      </Card>
